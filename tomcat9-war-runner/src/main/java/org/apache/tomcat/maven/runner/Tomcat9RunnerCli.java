...
public class Tomcat9RunnerCli
{
        ...
        throws Exception
    {
        ...
        {
            tomcat9Runner.clientAuth = clientAuth.getOpt();
        }
        ...
        {
            tomcat9Runner.loggerName = line.getOptionValue( loggerName.getOpt() );
        }

        if ( line.hasOption( uriEncoding.getOpt() ) )
        {
            tomcat9Runner.uriEncoding = line.getOptionValue( uriEncoding.getOpt() );
        }
